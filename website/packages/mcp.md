...
workspace-internal from the next release on: it is bundled into this server, the
CLI, and the testing adapter, and there is nothing to install by that name. Two narrower doors stay open, neither a
replacement for it:
