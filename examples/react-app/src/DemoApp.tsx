  ...
  return (
    <>
        ...
        <section aria-labelledby="profile-heading" style={{ marginBottom: 40 }}>
          ...
          >
            ...
            <div style={labelStyle}>
              <span aria-hidden="true">Timezone (unlabeled — intentional demo)</span>
            ...
            <div style={{ display: "flex", gap: 8 }}>
              ...
              <button type="button" onClick={openDialog} style={secondaryBtnStyle}>
                Delete account
              </button>
            </div>
          </form>
      ...
      <dialog
        ...
        style={{ borderRadius: 8, border: "none", padding: 24, maxWidth: 400, width: "90%" }}
        onClose={closeDialog}
      >
        <h2 id="confirm-title" style={{ marginBottom: 8 }}>Delete account?</h2>
        ...
        <div style={{ display: "flex", gap: 8, justifyContent: "flex-end" }}>
          ...
          <button
            type="button"
            onClick={closeDialog}
            style={{ ...primaryBtnStyle, background: "#d00", borderColor: "#d00" }}
          >
...
const inputStyle: React.CSSProperties = {
  ...
  borderRadius: 4, font: "inherit", fontSize: "1rem",
};

const primaryBtnStyle: React.CSSProperties = {
  padding: "8px 16px", background: "#2e79ff", color: "white",
  border: "1px solid #2e79ff", borderRadius: 4, cursor: "pointer", font: "inherit",
};

const secondaryBtnStyle: React.CSSProperties = {
  padding: "8px 16px", background: "transparent", color: "#333",
  border: "1px solid #ccc", borderRadius: 4, cursor: "pointer", font: "inherit",
};
