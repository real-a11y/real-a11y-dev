...
> **Also in this PR:** [`native-tree-v2.md`](./native-tree-v2.md) — companion refinements (AccNode, native defaults for cli/mcp/**testing/playwright**, read-vs-act). **Spikes:** [`native-tree-spike.md`](./native-tree-spike.md) + `packages/browser/spike/native-tree/` + `packages/testing/spike/playwright-native/`.
