...
it("ignores a full net::ERR_ token echoed back from the URL itself", async () => {
  const session = fakeSessionThatThrows(
    "page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:3000/search?q=net::ERR_NAME_NOT_RESOLVED",
  );
